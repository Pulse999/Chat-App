      ...
      <div className='w-5/6 max-w-2xl backdrop-blur-2xl text-gray-300 border-2
       border-gray-600 flex items-center justify-between max-sm:flex-col-reverse rounded-lg'>
        <form onSubmit={handleSubmit} className='flex flex-col gap-5 p-10 flex-1'>
          ...
          type="text" required placeholder='Your name' className='b-2 border border-gray-500 rounded-md focus:outline-none focus:ring-2
          ...
          <button type="submit" className='bg-gradient-to-r from-blue-400 to-red-600 
        ...
        src={authUser?.profilePic || assets.buddy} alt="" />
      </div>
    </div>
  )
}
